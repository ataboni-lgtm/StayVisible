...
CREATE UNIQUE INDEX IF NOT EXISTS "voice_profiles_client_id_idx" ON "voice_profiles" ("client_id");
CREATE INDEX IF NOT EXISTS "opportunities_client_id_idx" ON "post_opportunities" ("client_id");
CREATE INDEX IF NOT EXISTS "opportunities_status_idx" ON "post_opportunities" ("status");
...
CREATE INDEX IF NOT EXISTS "approvals_post_id_idx" ON "approvals" ("post_id");
CREATE INDEX IF NOT EXISTS "approvals_client_id_idx" ON "approvals" ("client_id");
CREATE INDEX IF NOT EXISTS "approvals_token_idx" ON "approvals" ("approval_token");
...
CREATE UNIQUE INDEX IF NOT EXISTS "social_accounts_client_provider_idx" ON "social_accounts" ("client_id", "provider");
CREATE INDEX IF NOT EXISTS "edit_feedback_client_id_idx" ON "edit_feedback" ("client_id");
CREATE INDEX IF NOT EXISTS "edit_feedback_post_id_idx" ON "edit_feedback" ("post_id");
CREATE INDEX IF NOT EXISTS "weekly_ideas_client_id_idx" ON "weekly_ideas" ("client_id");
CREATE INDEX IF NOT EXISTS "weekly_ideas_status_idx" ON "weekly_ideas" ("status");
