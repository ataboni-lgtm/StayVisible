...
export default async function EditClientPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <div className="@container/page mx-auto max-w-4xl">
    <PageHeader eyebrow="Client profile" title={`Edit ${client.firstName} ${client.lastName}`} description="Update contact details, professional context, status, and content preferences." />
